...
\begin{equation}\label{eq:interaction-hamiltonian-lattice-density}
	...
	\right)
\end{equation}
The detailed derivation can be found in \cite[Sec.~6.1.2]{giamarchi2003quantum}. The starting point is the expansion of $\hat \rho$, carried out in terms of physical fields $\hat \psi$ or shifted fields $\hat \Psi_s$,
...
\begin{equation}\label{eq:XXZ-luttinger-hamiltonian}
	...
	\end{cases}
\end{equation}
This simple result is a consequence of the many approximations I made. It is far from exact and strictly perturbative. By the means of Bethe Ansatz, a much better result can be obtained.