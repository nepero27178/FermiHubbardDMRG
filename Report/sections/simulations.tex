...
Our final aim is to extract the Bosonization parameters $u$ and $K$ for the spinless Fermi-Hubbard model of Eq.~\eqref{eq:spinless-hamiltonian-pbc}. Following the lead the $\mathrm{XXZ}$ mapping, we expect the model to exhibit \todo 
